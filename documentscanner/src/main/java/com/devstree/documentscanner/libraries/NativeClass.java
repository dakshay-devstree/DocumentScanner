package com.devstree.documentscanner.libraries;

import android.graphics.Bitmap;

import com.devstree.documentscanner.helpers.ImageUtils;
import com.devstree.documentscanner.helpers.MathUtils;
...
public class NativeClass {
    ...
    private static final Comparator<MatOfPoint2f> AreaDescendingComparator = (m1, m2) -> {
    ...
    private boolean isRectangle(MatOfPoint2f polygon, int srcArea) {
        ...
        if (!Imgproc.isContourConvex(polygonInt)) return false;
